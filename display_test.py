...
from display import display_leaderboard, unpack_tuple
from bowling_calculator import Player


class TestDisplay(unittest.TestCase):
    def test_unpack_tuple(self):
        test_player = Player('John', ['12', '45', '5/', '8-', '9/', 'X', 'X', 'X', 'X', 'X'], 56)
        self.assertEqual(unpack_tuple(test_player), ('John', ['12', '45', '5/', '8-', '9/', 'X', 'X', 'X', 'X', 'X'], 56))
